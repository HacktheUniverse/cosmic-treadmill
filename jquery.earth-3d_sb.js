...
function loadEarth(speed) {
  $.widget('ui.earth3d', {
    options: {
      ...
      // defaultSpeed: 20, // ORIGINAL; need to ramp or switch to this speed when runner starts running
      defaultSpeed: speed,  // the planet is halted at beginning, and the sun should be setting     
